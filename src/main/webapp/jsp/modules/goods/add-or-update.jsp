            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑物资</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>物资数量</label>
                                    <input id="goodsNumber" name="goodsNumber" value="0" class="form-control" readonly
                                           onchange="goodsNumberChickValue(this)"  placeholder="物资数量">
                                </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                goodsName: "物品名字不能为空",
                goodsTypes: "物品种类不能为空",
                goodsNumber: "物资数量不能为空",
                goodsPhoto: "物品图片不能为空",
                danwei: "单位不能为空",
                danjia: "单价不能为空",
                goodsContent: "物资详情不能为空",
                flag: "是否删除不能为空",
            }
        }).form();
    }
