            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">物资管理</li>
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                物品种类
                                                <select name="goodsTypesSelectSearch" style="width: 100px;" id="goodsTypesSelectSearch" class="form-control form-control-sm"
                                        ...
                                        <label>
                                            单价
                                            <input type="text" id="danjiaStartSearch" style="width: 100px;" onchange="danjiaChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                        </label>
                                            -
                                        <label>
                                            <input type="text" id="danjiaEndSearch"  style="width: 100px;" onchange="danjiaChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                        </label>
                                                                                                

                                <button onclick="search()" type="button" class="btn btn-primary">查询</button>
                                <button onclick="add()" type="button" class="btn btn-success 新增">添加</button>
                                <button onclick="graph('goods_number','goods')" type="button" class="btn btn-success 报表">报表</button>
