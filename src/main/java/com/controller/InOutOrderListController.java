...
public class InOutOrderListController {
    ...
    */
    ...
    public R save(@RequestBody InOutOrderListEntity inOutOrderList, HttpServletRequest request){
        ...
        Wrapper<InOutOrderListEntity> queryWrapper = new EntityWrapper<InOutOrderListEntity>()
            .eq("in_out_order_id", inOutOrderList.getInOutOrderId())
            .eq("goods_id", inOutOrderList.getGoodsId())
            .eq("order_number", inOutOrderList.getOrderNumber())
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        InOutOrderListEntity inOutOrderListEntity = inOutOrderListService.selectOne(queryWrapper);
        if(inOutOrderListEntity==null){
